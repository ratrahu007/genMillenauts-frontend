...
// It serves as the primary introduction to the platform, featuring a prominent headline,
// a brief description of the services, key feature highlights, calls to action, and impressive statistics.
// The design includes a background pattern and a visually engaging image with floating UI elements to create a modern and dynamic feel.

import { ArrowRight, Sparkles, Shield, Heart } from "lucide-react";

// HeroSection component: The main introductory section at the top of the landing page.
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-background via-accent/20 to-secondary/30 py-20 sm:py-32">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Left Column: Text Content and Calls to Action */}
          <div className="space-y-8">
            ...
            {/* Pills highlighting key features. */}
